...
// Just saying this whole thing needs a rewrite. If possible take inspiration from Vote Extend.
// Also that DB didn't do shit since there is surftimer include. Can someone tell me why was it there?
...
public void OnPluginStart()
{
	...
	g_Cvar_CanSpecVote = CreateConVar("sm_rtv_canspecvote", "1", "Are Spectators counting towards rtv. 1 - Allow, 0 - Deny", _, true, 0.0, true, 1.0);	
...
{
	if (!GetConVarBool(g_Cvar_CanSpecVote))
	{
